...
class DisjointSets {
	...
	public:
 		...
 		*
 		* That is, when you setunion two disjoint sets, the smaller (in terms of number of nodes) should point at
 		* the larger. This function works as described in lecture, except that you should not assume that the
 		...
 		* first. (Note that normally we could break this tie arbitrarily, but in this case we want to control 
 		* things for grading.)
 		*/
