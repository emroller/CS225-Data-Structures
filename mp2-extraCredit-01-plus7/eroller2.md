...
### ✗ - [0/1] - Image saturate() saturates a pixels by 0.1

- **Points**: 0 / 1


```
Original: img.getPixel(10, 10).s + 0.1 == result.getPixel(10, 10).s
Expanded: 0.2 == 0.1
```
...
### ✗ - [0/1] - Image scale(0.5) results in the correct width/height
